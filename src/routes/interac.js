...
router.post(
  ...
  upload.any(),
  interacController.createComment,
);

router.post(
  '/create-child-comment',
  authMiddleware.veryfiTokenActive,
  interacController.createChildComment,
);
...
router.put(
  ...
  authMiddleware.veryfiTokenActive,
  upload.any(),
  interacController.updateComment,
);

router.put(
  '/update-child-comment',
  authMiddleware.veryfiTokenActive,
  interacController.updateChildComment,
);
...
router.delete(
  ...
  authMiddleware.veryfiTokenActive,
  interacController.deleteChildComment,
);

router.get(
  '/history-comment',
  authMiddleware.veryfiTokenActive,
  interacController.getHistoryComment,
);
...
router.delete(
  '/dislike-comment',
  authMiddleware.veryfiTokenActive,
  interacController.dislikeComment,
);
...
router.put(
  '/allnotification',
  authMiddleware.veryfiTokenActive,
  interacController.updateAllNotification,
);
