...
//change avater image
router.post("/avatar", authMiddleware.veryfiTokenActive, upload.single("image"), userController.changeAvatar);

//change cover image
router.post("/coverimage", authMiddleware.veryfiTokenActive, upload.single("image"), userController.changeCoverImage);
